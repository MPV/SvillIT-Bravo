class FacilitiesController < ApplicationController
  ...
  # GET /facilities.xml
  def index
    @facilities = Facility.find(:all, :order => 'facility_type, name')
  ...
  def create
    ...
    respond_to do |format|
      if @facility.save
        flash[:notice] = 'Facilitet skapades!'
        format.html { redirect_to(facilities_path) }
  ...
  def update
    ...
    respond_to do |format|
      if @facility.update_attributes(params[:facility])
        flash[:notice] = 'Facilitet &auml;ndrades!'
